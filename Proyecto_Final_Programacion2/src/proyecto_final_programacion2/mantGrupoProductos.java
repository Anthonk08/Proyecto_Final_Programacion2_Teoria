 ...
 */
public class mantGrupoProductos extends javax.swing.JFrame {

    /**
     * Creates new form mantGrupoProductos
     */
    public mantGrupoProductos() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mantGrupoProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mantGrupoProductos().setVisible(true);
            }
        });
    }
